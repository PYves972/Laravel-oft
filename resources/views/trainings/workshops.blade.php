...
<div class="min-h-screen bg-[#F9F8F3] pt-28 pb-16 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto space-y-8">
        ...
        <div class="text-center max-w-3xl mx-auto space-y-3">
            <h1 class="font-serif text-4xl font-bold text-[#2D3B22]">Nos Ateliers Créatifs</h1>
            <p class="text-gray-600">Explorez le tricot, le crochet, la teinture, la broderie et le tissage au sein de notre atelier.</p>
        </div>
